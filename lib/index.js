 ...
 *   - Deep imports (`claude-code-vault-keeper/lib/<file>.js`) are also
 *     supported via the package's `exports` map, but are documented as a
 *     compatibility surface; new code should prefer the barrel or the
 *     named subpaths (`./parser`, `./validators`, …).
 *
